...
const profileSectionsStyles = {
    ...
    addButton: "rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-2.5 text-sm font-medium text-white shadow-md hover:from-blue-700 hover:to-indigo-700",
    sectionCard: "relative grid grid-cols-1 md:grid-cols-2 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm",
