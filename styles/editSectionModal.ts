const editSectionModalStyles = {
    ...
    input:
      "w-full rounded-lg border border-gray-300 p-2 text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500",
    textarea:
      "w-full rounded-lg border border-gray-300 p-2 text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500",
    select:
      "w-full rounded-lg border border-gray-300 p-2 text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500",
  ...
  export default editSectionModalStyles;
