const blogPageStyles = {
    light: {
      ...
      header: "mb-6 flex flex-col justify-between gap-4 border-b border-gray-200 pb-4 sm:flex-row sm:items-center",
      title:
    ...
    dark: {
      ...
      header: "mb-6 flex flex-col justify-between gap-4 border-b border-gray-700 pb-4 sm:flex-row sm:items-center",
      title:
